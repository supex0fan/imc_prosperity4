'''
Copy of the datamodel.py file provided by propserity via the notion. 
DO NOT MODIFY THIS FILE. It must be used as is or our submission will interact with their hosted version and the submission will crash.
'''
